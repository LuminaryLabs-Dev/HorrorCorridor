...
import type { PlayerViewAngles } from "@/features/player/domain/cameraLook";
...
export default function Minimap({
  ...
  useEffect(() => {
    ...
    for (const player of snapshot.players) {
      ...
      context.beginPath();
      context.fillStyle = player.isHost ? "rgba(255, 255, 255, 0.85)" : "rgba(145, 255, 157, 0.75)";
  ...
  }, [localPlayerId, localPosition.x, localPosition.z, snapshot, viewAngles.yaw]);
